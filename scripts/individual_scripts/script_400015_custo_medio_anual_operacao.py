...
def save_response(guid, url_code, url_title, data, output_dir="responses_400015"):
...
def main():
    ...
    url_code = "400015"
    url_title = "custo_medio_anual_operacao"
    ...
    try:
        ...
        print(f"Diretório de saída: responses_400015")
