...
def make_api_call(guid, session=None):
    """Faz uma chamada à API para a URL 2000720 (subsecretaria)."""
    base_url = "https://api.sif-source.org"
    endpoint = f"/projects/{guid}/questions/search/2000720"
    ...
    try:
        ...
        error_file = os.path.join(error_dir, f"error_{guid}_2000720.json")
        ...
        error_msg = f"Erro ao acessar a API para GUID {guid} e URL 2000720: {str(e)}"
        print(error_msg)
